  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2 justify-end">
        {stats.map(({ label, value, nilTotal, palette }) => (
          <div
            key={label}
            style={palette.style}
            className={`flex flex-col items-center gap-0.5 rounded-lg border px-3 py-2 min-w-[64px] ${palette.text} ${palette.bg} ${palette.border}`}
          >
            <span className="text-[10px] font-crayon uppercase tracking-wide">{label}</span>
