...
function FileDropZone({ files, onFilesChange }) {
  ...
  return (
    <div className="space-y-2 rounded-md border border-border p-3 dark:border-darkborder">
      <div>
        <p className="text-sm font-semibold text-textPrimary dark:text-white">Schedule Screenshots</p>
        <p className="text-xs text-textSecondary">Upload as many screenshots as it takes to cover the whole week.</p>
      </div>
      <input
        type="file"
        accept="image/*"
